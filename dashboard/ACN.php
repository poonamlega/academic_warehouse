            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Advanced Computer Network (CS348)</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="subjects.php">My Subjects</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Advanced Computer Network</li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        <div class="title">
                            <h3>Advanced Computer Network (CS-348)</h3>
                        </div> <!-- title -->
                            ...
                            <ul>
                                <li>
                                    <div class="teacher-name">
                                        ...
                                        <div class="name">
                                            ...
                                            <h6><a href='profile.php'>Mrs. Moumita Ghosh</a></h6>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="teacher-name">
                                        ...
                                        <div class="name">
                                            <span>Expert Faculty</span>
                                            <h6><a href='profile.php'>Mr. Sisir Kumar Jeena</a></h6>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                               <h4>Earned Grades </h4>
                                <ul>
                                    <li><i class="fa fa-file-o"></i>Mid Semester : <span>10</span></li>
                                    <li><i class="fa fa-clone"></i>Assignments & Tests : <span>09</span></li>
                                    <li><i class="fa fa-beer"></i>Quizzes :  <span>05</span></li>
                                    <li><i class="fa fa-file-o"></i>End Semester :  <span>30</span></li>
                                    <li><i class="fa fa-user-o"></i>Total :  <span>54/100</span></li>
                                </ul>
                            </div> <!-- course features -->
                        </div>
                        <div class="col-lg-12 col-md-6">
