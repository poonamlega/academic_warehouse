            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Compiler Design (CS304)</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="subjects.php">My Subjects</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Compiler Design</li>
                            </ol>
                        </nav>
                            ...
                            <ul>
                                <li>
                                    <div class="teacher-name">
                                        <div class="thum">
                                            <img src="images/subjects/teacher/t-2.jpg" alt="Faculties">
                                        </div>
                                        <div class="name">
                                            <span>Expert Faculty</span>
                                            <h6><a href='profile.php'>Mrs. Garima Verma</a></h6>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="teacher-name">
                                        ...
                                        <div class="name">
                                            <span>Expert Faculty</span>
                                            <h6><a href='profile.php'>Mr. Ranjeet Kumar Singh</a></h6>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="teacher-name">
                                        <div class="thum">
                                            <img src="images/subjects/teacher/t-3.jpg" alt="Faculties">
                                        </div>
                                        <div class="name">
                                            <span>Expert Faculty</span>
                                            <h6><a href='pofile.php'>Mr. Saurabh Kumar</a></h6>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="teacher-name">
                                        <div class="thum">
                                            <img src="images/subjects/teacher/t-4.jpg" alt="Faculties">
                                        </div>
                                        <div class="name">
                                            <span>Expert Faculty</span>
                                            <h6><a href='pofile.php'>Miss. Aditi Sharma</a></h6>
                                        </div>
                                    </div>
                                </li>
                            </ul>
