            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Intelligent Systems (IB303)</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="subjects.php">My Subjects</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Intelligent Systems</li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        <div class="title">
                            <h3>Intelligent Systems (IB303)</h3>
                        </div> <!-- title -->
                            ...
                            <ul>
                                <li>
                                    <div class="teacher-name">
                                        ...
                                        <div class="name">
                                            ...
                                            <h6><a href='profile.php'>Mr. Aman Singh</a></h6>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="teacher-name">
                                        ...
                                        <div class="name">
                                            <span>Expert Faculty</span>
                                            <h6><a href='profile.php'>Mr. Ajay Singh</a></h6>
                                        </div>
                                    </div>
                                </li>
                                <li>
