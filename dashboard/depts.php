           ...
           <div class="row">
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="images/depts/dp-1.jpg" alt="School Of Computing">
                        </div>
                        <div class="cont">
                            <a href="soc.php"><h6>School Of Computing</h6></a>
                            
                        </div>
                    </div> <!-- School Of Computing -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="images/depts/dp-2.jpg" alt="IT Department">
                        </div>
                        <div class="cont">
                            <a href="IT.php"><h6>IT Department </h6></a>
               ...
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="images/depts/dp-3.jpg" alt="Mechanical Dept.">
                        </div>
                        <div class="cont">
                            <a href="me.php"><h6>Mechanical Dept.</h6></a>
                            
                        </div>
                    </div> <!-- Mechanical Department -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="images/depts/dp-4.jpg" alt="Civil Dept.">
                        </div>
                        <div class="cont">
                            <a href="civil.php"><h6>Civil Dept.</h6></a>
                            
                        </div>
                    </div> <!-- Civil Department -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="images/depts/dp-5.jpg" alt="Depart. Of Pharmacy">
                        </div>
                        <div class="cont">
                            <a href="pharmacy.php"><h6>Depart. Of Pharmacy</h6></a>
                            
                        </div>
                    </div> <!-- Depart. Of Pharmacy -->
               </div>
               <div class="col-lg-3 col-sm-6">
                <div class="singel-teachers mt-30 text-center">
                     <div class="image">
                         <img src="images/depts/dp-6.jpg" alt="Depart. Of Archite.">
                     </div>
                     <div class="cont">
                         <a href="archi.php"><h6>Depart. Of Architecture</h6></a>
                ...
                <div class="col-lg-12">
                    <nav class="courses-pagination mt-50">
                        <ul class="pagination justify-content-center">
                            <li class="page-item">
                                <a href="depts.php" aria-label="Previous">
