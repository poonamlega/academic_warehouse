            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Entrepreneurship & Start Up (ME381)</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="subjects.php">My Subjects</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Entrepreneurship & Start Up</li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        <div class="title">
                            <h3>Entrepreneurship & Start Up (ME381)</h3>
                        </div> <!-- title -->
                            ...
                            <ul>
                                <li>
                                    <div class="teacher-name">
                                        ...
                                        <div class="name">
                                            ...
                                            <h6><a href='profile.php'>Mr. Anurag Aeron</a></h6>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="teacher-name">
                                        ...
                                        <div class="name">
                                            <span>Expert Faculty</span>
                                            <h6><a href='profile.php'>Mr. A.N. Shukla</a></h6>
                                        </div>
                                    </div>
                                </li>
                            </ul>
