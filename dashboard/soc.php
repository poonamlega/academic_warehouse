           ...
           <div class="row">
               ...
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="profilehod.php"><h6>Dr. Vishal Bharti </h6></a>
               ...
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="profile.php"><h6>Miss. Diksha Pandit</h6></a>
                            <span>IBM Faculty</span>
                        </div>
                    </div> <!-- IBM Faculty -->
               </div>
               <div class="col-lg-3 col-sm-6">
                <div class="singel-teachers mt-30 text-center">
                     ...
                     <div class="cont">
                         <a href="profile.php"><h6>Mr. Ajay Singh</h6></a>
                         <span>IBM Faculty</span>
                     </div>
                 </div> <!-- IBM Faculty -->
            </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="profile.php"><h6>Miss. Bhavana Chilwal </h6></a>
                            <span>Faculty</span>
                        </div>
                    </div> <!-- Faculty -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="profile.php"><h6>Mrs. Moumita Ghosh</h6></a>
                            <span>Faculty</span>
                        </div>
                    </div> <!-- Faculty -->
               </div>
                ...
                <div class="col-lg-12">
                    <nav class="courses-pagination mt-50">
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item"><a href="soc2.php">2</a></li>
