                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">SOC Faculties</li>
                            </ol>
                        </nav>
           ...
           <div class="row">
               ...
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="teachers-singel.php"><h6>Mr. Ajay Shankar</h6></a>
                            <span>Faculty</span>
                        </div>
                    </div> <!--Faculty -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="images/teachers/t-5.jpg" alt="Faculty">
                        </div>
                        <div class="cont">
                            <a href="teachers-singel.php"><h6>Mr. Rohit Tyagi</h6></a>
                            <span>Faculty</span>
                        </div>
                    </div> <!--  Faculty -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="images/teachers/t-4.jpg" alt=" Faculty">
                        </div>
                        <div class="cont">
                            <a href="teachers-singel.php"><h6>Mrs. Garima Verma</h6></a>
                            <span>Faculty</span>
                        </div>
                    </div> <!--  Faculty -->
               </div>
               <div class="col-lg-3 col-sm-6">
                <div class="singel-teachers mt-30 text-center">
                     <div class="image">
                         <img src="images/teachers/t-7.jpg" alt="Faculty">
                     </div>
                     <div class="cont">
                         <a href="teachers-singel.php"><h6>Mr. Ranjeet Kumar Singh</h6></a>
                         <span>Faculty</span>
                     </div>
                 </div> <!--  Faculty -->
            </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="teachers-singel.php"><h6>Miss. Aditi Sharma </h6></a>
                            <span>Faculty</span>
                        </div>
                    </div> <!-- Faculty -->
               </div>
               <div class="col-lg-3 col-sm-6">
                   <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href="teachers-singel.php"><h6>Mr. Saurabh Kumar</h6></a>
                            <span>Faculty</span>
                        </div>
                    </div> <!-- Faculty -->
               </div>
                ...
                <div class="col-lg-12">
                    <nav class="courses-pagination mt-50">
                        <ul class="pagination justify-content-center">
                            <li class="page-item">
                                <a href="soc.php" aria-label="Previous">
                                    <i class="fa fa-angle-left"></i>
                                </a>
                            </li>
                            <li class="page-item"><a href="soc.php">1</a></li>
                            <li class="page-item"><a class="active" href="#">2</a></li>
                            <li class="page-item">
                                <a href="soc2.php" aria-label="Next">
